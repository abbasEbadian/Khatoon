...
function Order() {
  return (
    <UserPanelBase active={"pendin_orders"} underline_dec={false} title={false}>
      <section>
        ...
        <div className={`${styles.order} ${styles.order_card}`}>
          <div className="d-flex p-5 align-items-center">
            ...
            />
            <div className="mx-3">
              <h6>دفتر جلددار صحافی دوختی پارچه ای</h6>
        ...
        <div className={`${styles.order_detail} ${styles.order_card}`}>
          <div className={styles.order_detail_item}>
            ...
            <div className={styles.order_detail_item_value}>  1398</div>
          </div>
          <div className={styles.order_detail_item}>
            <div className={styles.order_detail_item_title}>هزینه ارسال</div>
            <div className={styles.order_detail_item_value}>11 مهر 1398</div>
          </div>
          <div className={styles.order_detail_item}>
            <div className={styles.order_detail_item_title}>مجموع مبلغ پرداختی</div>
            <div className={styles.order_detail_item_value}>تیپاکس</div>
          </div>
          <div className={styles.order_detail_item}>
            <div className={styles.order_detail_item_title}>کارمزد سایت</div>
            <div className={styles.order_detail_item_value + " " +  styles.site_fee}>23333333</div>
          </div>
        </div>
      </section>
    </UserPanelBase>
